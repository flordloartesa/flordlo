...
import { Play, X, Share2, Gift, Mail, MessageCircle, Instagram, Facebook, Telegram, Send } from 'lucide-react';
...
interface SanityEventProps {
  event: {
    ...
    // 👇 ADICIONADO: Tipos corrigidos para suportar heroDate, autorNome e precos nos cards
...
export default function EventosSoltosLayoutGUM({ event }: SanityEventProps) {
  ...
  // Lógica de Fallback para a Marquee
  const marqueeData = {
  ...
  const handleBookNow = () => {
    const precoReserva = event?.reservaPrice || 80;

    addToCart({
      _id: event?._id, 
      _type: "eventos", 
      title: `Save your place - ${event?.titulo || "GUM Retreat"}`, 
      price: precoReserva, 
    ...
    <div className="min-h-screen bg-[#FDFDFD]  text-slate-800 font-sans overflow-x-hidden selection:bg-slate-200">
      ...
      <section className="hero-section">
        ...
        <div className="logos-row">
            <div className="logo-placeholder">Retreat</div>
            <div className="logo-placeholder">Weekend</div>
...
<p className="text-xs uppercase tracking-[0.3em] text-slate-400 mb-1 font-medium">
          ...
          Transform how you support young minds. A dynamic weekend retreat on teaching mindfulness to kids and teens—building resilience, boosting focus, 
          and creating lasting well-being.
          </p>
...
<div className="grid grid-cols-3 gap-2 sm:gap-2 w-full max-w-[450px] mx-auto lg:mx-0 py-2 px-6 bg-white rounded-full border border-slate-100 shadow-sm mb-12 -mt-2 text-center lg:text-left">
 ...
 {/* Coluna 1: Data */}
  <div className="flex flex-col items-center lg:items-start">
    <span className="text-[10px] uppercase tracking-[0.2em] text-slate-400 mb-0 font-bold whitespace-nowrap">Date</span>
  ...
  <div className="flex flex-col items-center lg:items-start border-x border-slate-200 px-2 sm:px-4">
    <span className="text-[10px] uppercase tracking-[0.2em] text-slate-400 mb-0 font-bold whitespace-nowrap">Venue</span>
  ...
  {/* Coluna 3: Idioma */}
  <div className="flex flex-col items-center lg:items-start">
    <span className="text-[10px] uppercase tracking-[0.2em] text-slate-400 mb-0 font-bold whitespace-nowrap">Language</span>
    <span className="text-[10px] font-medium text-slate-900 leading-tight ">
        ...
        />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 text-left">
            ...
            <div className="feature-card">
              ...
              <p className="feature-text"> Arts, Games, Sports+ Explore creative ways to make mindfulness fun by integrating it into the activities they are most interested in and enjoy: Bring mindfulness to games for kids who struggle with attention </p>
            </div>
...
<section className="bg-[#FBC78D] flex items-center justify-center font-sans w-full max-w-[1300px] mx-auto rounded-[2rem] py-8 md:py-16 px-4 md:px-0 -mt-12 md:-mt-10 ">
  ...
  <div className="max-w-4xl mx-auto">
    ...
    <div className="border-t border-slate-200">
      <button onClick={() => toggleAccordion('readings')} className="w-full flex justify-between items-center py-6 text-[20px] md:text-[30px]  tracking-wide font-normal text-slate-500 hover:text-slate-800 transition-colors">
  ...
  <ul className="space-y-6 list-none pl-0">
    ...
    <div className="border-t border-b border-slate-200">
      <button onClick={() => toggleAccordion('faq')} className="w-full flex justify-between items-center py-6 text-[20px] md:text-[30px] tracking-wide font-normal text-slate-500 hover:text-slate-800 transition-colors">
  ...
  Register
    ...
    <div className="max-w-4xl mx-auto mt-12 bg-[#1E293B]/40 backdrop-blur-sm rounded-2xl p-8 md:p-10 border border-slate-700/50">
      ...
      <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-5 text-[10px] text-slate-300 leading-relaxed">
        ...
        <li className="flex items-start gap-3">
          <span className="mt-2 w-1.5 h-1.5 rounded-full bg-[#00AEEF] shrink-0 shadow-[0_0_8px_#00AEEF]"></span>
          <p>After registering, your registration will only be valid after the payment of €80 deposit. The €80 is already a portion of the full payment.</p>
        </li>
    ...
    <div className="max-w-[1300px] mx-auto overflow-hidden">
      ...
      >
        {event.suggestedEvents.map((evt) => (
          <Link 
            // 👇 Lógica inteligente que diferencia Retiros de Eventos
          ...
          >
            ...
            <div className="relative h-full flex flex-col p-6 z-10">
              ...
              {/* 👇 AQUI ESTÁ A LÓGICA CORRIGIDA DA DATA (HeroDate ou DataEventoTexto) */}
              <div className="flex justify-between items-start mb-2">
                <span className="border border-white/30 bg-white/10 backdrop-blur-md text-white text-[8px] font-bold px-3 py-1 rounded uppercase tracking-wider">
